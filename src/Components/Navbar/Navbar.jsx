...
//             <li key={i}>
//               <NavLink
//                 to={user || link.name === "Home" || link.name === "About" ? link.path : "/signin"}
//                 className={({ isActive }) =>
//                   isActive
...
//             <button onClick={handleSignOut} className="btn bg-red-600 hover:bg-red-700 transition">
//               Sign Out
//             </button>
//           </div>
//         ) : (
//           <>
//             <NavLink to="/signin" className="btn bg-blue-600 hover:bg-blue-700 mr-2">
//               Sign In
//             </NavLink>
//             <NavLink to="/signup" className="btn bg-indigo-600 hover:bg-indigo-700">
//               Sign Up
//             </NavLink>
//           </>
//         )}
...
const Navbar = () => {
  ...
  const handleSignOut = async () => {
    try {
      ...
      resetProfile();      // UserContext reset
      toast.success("Signed out successfully ✅");
